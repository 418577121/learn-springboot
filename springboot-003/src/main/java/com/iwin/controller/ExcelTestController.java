...
import com.iwin.config.UploadDataListener;
import com.iwin.entity.DownloadData;
 ...
 * @description: 测试下载 excel
 * @author: DingHaiTing
 * @create_time: 2021-08-19 23:33
 **/
...
public class ExcelTestController {
    ...
    public String upload(MultipartFile file) throws IOException {
        EasyExcel.read(file.getInputStream(), UploadData.class, new UploadDataListener(readExcelService)).sheet().doRead();
        return "success";
    }
    /**
